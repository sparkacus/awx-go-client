...
// Client manages communication with AWX V2 API.
type Client struct {
	// HTTP client used to communicate with the AWX API.
	client *http.Client
...
// Response is a AWX response. This wraps the standard http.Response returned from AWX.
